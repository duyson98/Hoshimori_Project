    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obtain_method', models.CharField(max_length=100, verbose_name='Obtain Method')),
                ('image', models.ImageField(upload_to=hoshimori.models.uploadItem(b'c/icon'), verbose_name='Icon')),
                ('special_icon', models.ImageField(upload_to=hoshimori.models.uploadItem(b'c/icon/special'), verbose_name='Special Icon')),
                ...
                ('charge_hit', models.CharField(max_length=50, verbose_name='Charge hits')),
