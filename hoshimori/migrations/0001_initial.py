    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=hoshimori.models.uploadItem(b'c'), verbose_name='Icon')),
                ('special_icon', models.CharField(max_length=50, verbose_name='Special Icon')),
                ('art', models.ImageField(upload_to=hoshimori.models.uploadItem(b'c/art'), null=True, verbose_name='Art')),
                ('special_front', models.CharField(max_length=50, verbose_name='Special Front')),
                ('front_top', models.CharField(max_length=50, verbose_name='Front Top')),
                ('front_bottom', models.CharField(max_length=50, verbose_name='Front Bottom')),
                ('front_name', models.CharField(max_length=50, verbose_name='Front Name')),
                ('front_rarity', models.CharField(max_length=50, verbose_name='Front Rarity')),
                ('front_weapon', models.CharField(max_length=50, verbose_name='Front Weapon')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(unique=True, max_length=50, verbose_name='Irous Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveIntegerField(default=70, verbose_name='Level', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(70)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ideal_1', models.CharField(max_length=100, verbose_name='Ideal model 1')),
                ('ideal_2', models.CharField(max_length=100, verbose_name='Ideal model 2')),
                ('ideal_3', models.CharField(max_length=100, verbose_name='Ideal model 3')),
                ...
                ('signature', models.ImageField(upload_to=hoshimori.models.uploadItem(b's/sign'), verbose_name='Signature')),
                ('phrase_1', models.FileField(upload_to=hoshimori.models.uploadItem(b's/voices'), verbose_name='Phrase 1')),
                ('phrase_2', models.FileField(upload_to=hoshimori.models.uploadItem(b's/voices'), verbose_name='Phrase 2')),
                ('introduction_1', models.FileField(upload_to=hoshimori.models.uploadItem(b's/voices'), verbose_name='Introduction 1')),
                ('introduction_2', models.FileField(upload_to=hoshimori.models.uploadItem(b's/voices'), verbose_name='Introduction 1')),
                ('_cache_totals_last_update', models.DateTimeField(null=True)),
